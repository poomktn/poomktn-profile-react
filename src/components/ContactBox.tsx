...
export function ContactBox() {
  ...
  return (
    <Box color="orange">
    <div className="mb-1"><b>Tel: </b>{TELEPHONE_NUMBER}</div>
    <div className="flex">
      <b>Email:</b>&nbsp;kuntanut.s@gmail.com&nbsp;
      <div className="relative no-print cursor-default">
        <div className="bg-black txt-white border-black text-center" style={{width: '20px'}}
    ...
    <div><b>Github:</b> <a href={GITHUB_LINK} target='_blank' rel="noreferrer">{GITHUB_LINK}</a></div>
  </Box>
  )
}
